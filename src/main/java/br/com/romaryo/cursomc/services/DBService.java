...
import br.com.romaryo.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiarteTestDatabase() throws ParseException {
		...
		Produto p7 = new Produto(null, "TV true coloor", 1200.00);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/08/2019 20:30"), cli1, e2);
